...
// uses babel as a compiler to transform the ECMAScript 6 code to ECMAScript 5 compatible code
'use babel';
...
export default {
  ...
  toggleEnforcing(){
    let newVal = !atom.config.get('atomic-management.enforceConfiguredPackages');
    atom.config.set('atomic-management.enforceConfiguredPackages', newVal);
  },
