...
export default {
  ...
  askReload() {
    atom.notifications.addInfo("Package Reloading", {detail: "These package changes will take affect when you reload Atom. You can do this with the command `Window: Reload` in the Command Palette"})
  },
