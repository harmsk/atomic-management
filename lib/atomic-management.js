...
export default {
  ...
  /**
   * Toggles to enable/disable the package manually. If the package is
   * disabled, then it will look for the correct configuration file, apply the
   * configuration specified in the configuration file, and notify users; if
   * the package is enabled, it disables the package and notifies users.
   */
  toggle() {
    if (this.isEnabled) {
