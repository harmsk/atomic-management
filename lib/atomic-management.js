          ...
          if (e.path.endsWith(FILE_EXTENSION)) {
            ...
            switch (e.action) {
              ...
              case "modified":
                ...
                break;
              case "deleted":
                // delete from enabledProjects if it is there
                const index = this.enabledProjects.indexOf(e.path);
                if (index > -1) {
                  this.enabledProjects.splice(index, 1);
                }
                this.setConfig();
                break;
            }
            ...
            // delete from enabledProjects if it is there
            const index = this.enabledProjects.indexOf(e.oldPath);
            if (index > -1) {
              this.enabledProjects.splice(index, 1);
            }
            this.setConfig();
