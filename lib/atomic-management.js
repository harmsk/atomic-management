...
export default {
  ...
  toggle() {
    if (this.isEnabled) {
      ...
      console.log(`in toggle, package is enabled`)
      this.isEnabled = false
  ...
  askReload() {
    atom.notifications.addInfo("Package Reloading", {detail: "These packages will take affect when you reopen Atom. You can do this with the command `Window: Reload` in the Command Palette"})
  },
